...
class Article extends BaseType
{
     ...
     * 
     *      1.) *id-value* URL references - uses *id-value* of an element in the
     * page being annotated. The simplest use of *speakable* has (potentially
