...
class Occupation extends BaseType
{
     ...
     * including, but not limited to industry, job title, and location.
     * Estimated salaries  are often computed by outside organizations rather
     * than the hiring organization, who may not have committed to the estimated
     * value.
     *
